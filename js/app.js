...
document.addEventListener('DOMContentLoaded', () => {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      // 1. Récupérer le prochain numéro
      ...
      alert('Erreur : ' + (err.message || 'Impossible d\'envoyer. Vérifie les règles Firestore et que la base est créée.'));
    } finally {
